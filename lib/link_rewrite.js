...
module.exports = function (N) {
  ...
  // Links to category
  //
  function link_to_category(N, params, callback) {
  ...
  //
  function link_to_attach_filedata(N, params, callback) {
    N.models.vbconvert.FileMapping
  ...
  //
  function link_to_attach_picture(N, params, callback) {
    N.models.vbconvert.FileMapping
  ...
  //
  function link_to_attach_blogentry(N, params, callback) {
    N.models.vbconvert.FileMapping
