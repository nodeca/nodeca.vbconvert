...
N.wire.on('navigate.done:admin.vbconvert', function vbconvert_forum_post_task_widget_setup() {
...
N.wire.on('navigate.exit:admin.vbconvert', function vbconvert_forum_post_task_widget_teardown() {
  if (!$(SELECTOR).length) return;
...
N.wire.once('navigate.done:admin.vbconvert', function vbconvert_forum_post_task_widget_setup_handlers() {
