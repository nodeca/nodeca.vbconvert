...
// avoid unintended lists
assert.equal(to_md(tokenize('1. foo\n2. bar')),
             '1\\. foo  \n2\\. bar');

// avoid unintended code blocks
assert.equal(to_md(tokenize('    foo\n')),
             'foo');
