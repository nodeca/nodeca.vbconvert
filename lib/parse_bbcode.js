...
//  - image_info (Object)  - image size data (for parser only)
//
...
//  - image_info (Object)  - image sizes (see parser docs)
//
...
module.exports = function (N) {
  ...
  return co.wrap(function* parse_bbcode(posts) {
    let parsed = [];
    ...
    return (yield Promise.map(parsed, co.wrap(function* (data) {
      ...
      try {
        ...
        N.logger.error('Failed to parse post id=' + post.id + ': ' + err.message);
        return;
      }
